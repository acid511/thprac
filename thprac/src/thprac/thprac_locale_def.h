...
enum th_glossary_t
{
    ...
    THPRAC_GAME_TIME_HINT_SE,
    THPRAC_GAME_TIME_HINT_SE_DESC,
    ...
    THPRAC_L2D_HYPER,
    THPRAC_L2D_KEYBIND,
    THPRAC_L2D_KEYBIND_BOMB,
    THPRAC_L2D_KEYBIND_BORDER_BREAK,
    THPRAC_L2D_KEYBIND_BORDER_BREAK_DESC,
    THPRAC_L2D_KEYBIND_DESC,
    THPRAC_L2D_KEYBIND_DYING,
    THPRAC_L2D_KEYBIND_DYING_DESC,
    THPRAC_L2D_KEYBIND_HYPER_DESC,
    THPRAC_L2D_KEYBIND_MISS,
    THPRAC_L2D_KEYBIND_RELEASING,
    THPRAC_L2D_KEYBIND_RESET,
    THPRAC_L2D_KEYBIND_TITLE,
    THPRAC_L2D_KEYBIND_TITLE2,
    THPRAC_L2D_SHOW_TIME,
    THPRAC_L2D_SHOW_TIME_DESC,
    THPRAC_LANGUAGE,
...
extern const char* th_glossary_str[3][1748];
...
extern const wchar_t __thprac_loc_range_zh[2927];

extern const wchar_t __thprac_loc_range_en[57];

extern const wchar_t __thprac_loc_range_ja[2367];
